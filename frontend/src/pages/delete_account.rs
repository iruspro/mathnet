...
pub fn delete_account_view() -> Node<Msg> {
    node! {
        <main>
...
<button type="button" class="btn btn-primary" on_click=|_|{Msg::SetPage(Page::PageSortSigned(SignedPage::UserProfileManagement))}>"Cancel deletion"</button>

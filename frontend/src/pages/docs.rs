...
pub fn docs_view(app: & App) -> Node<Msg> {
    log::info!("Successfully loaded docs page");
    ...
    match app.is_user_signed_in{
        false => {
            ...
            <div class="container-fluid">
                ...
                <li class="nav-item">
                    <a class="nav-link active btn btn-link" aria-current="page">"Docs"</a>
                </li>
                <li class="nav-item">
                    <button class="nav-link btn btn-link" type="button" on_click = |_|{Msg::SetPage(Page::PageSortShared(SharedPage::Docs))}>"Privacy and Security"</button>
                </li>
                    </ul>
                </div>
            </div>

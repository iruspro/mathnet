...
pub fn view(user_id:UserId) -> Node<DefinedMsg> {
    ...
    <button type="button" class="btn btn-primary" on_click=move|_|{DefinedMsg::SetPage(GoToPage::GoToPageSigned(SwitchToPageSigned::GoToUserProfile(user_id.clone())))}>"Cancel deletion"</button>

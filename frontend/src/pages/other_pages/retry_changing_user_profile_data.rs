...
pub fn view() -> Node<DefinedMsg> {
    ...
    <button type="button" class="btn btn-primary" on_click=|_|{DefinedMsg::SetPage(GoToPage::GoToPageSigned(SwitchToPageSigned::GoToUserProfile))}>"Go back to user profile"</button>
    </div>
    </div>
            </main>
        }

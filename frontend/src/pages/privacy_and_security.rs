...
use crate::app::App;
use crate::list_of_pages::{Page, SignedPage, UnsignedPage, OtherPage,SharedPage};

pub fn privacy_and_security_view(app: &App) -> Node<Msg>{
    log::info!("Successfully loaded privacy and security page");
    ...
    match app.is_user_signed_in{
        false => {
            ...
            <div class="container-fluid">
                ...
                <li class="nav-item">
                    <a class="nav-link active btn btn-link" aria-current="page">"Privacy and Security"</a>
                </li>
                    </ul>
                </div>
            </div>
...
node!{
    <aside class="left-sidebar">
            <div class="list-group">
                <button class="list-group-item list-group-item-action" type="button" on_click=move |_| Msg::SetPage(Page::PageSortShared(SharedPage::AboutProject))>
            "About project"
        </button>
